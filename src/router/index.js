        ...
        children: [
            {
                ...
                component: () => import('../views/static/projectAttribute.vue')
            },
            {
                path: '/projectAttributeCategory',
                name: 'projectAttributeCategory',
                component: () => import('../views/static/projectAttributeCategory.vue')
            },
            {
                path: '/projectCategory',
                name: 'projectCategory',
                component: () => import('../views/static/projectCategory.vue')
            },
            {
                path: '/project',
                name: 'project',
            ...
            },
            {
                path: '/brand',
                name: 'brand',
                component: () => import('../views/static/brand.vue')
            },
        ]
    },
    {
